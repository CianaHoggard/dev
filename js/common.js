...
(function($) {
   ...
   menuAnimation:function()
   {
       ...
       var themecolor="#117d8b";
      if(top_v>=30)
      {

          $(".nim-menu").css({height:"80px",padding:"15px",background:"#D3D3D3",boxShadow:"2px 2px 3px 3px rgba(0,0,0,0.3"});
      ...
      else
      {
          ...
          $(".nim-menu.navbar-default .navbar-nav > li > a").css("color","#D3D3D3");
          $(".nim-menu.navbar-default .navbar-nav > li > a:hover").css("color",themecolor);
          $(".nim-menu.navbar-default .navbar-nav > li > a").hover(function(){$(this).css("color",themecolor)},function(){$(this).css("color","#D3D3D3")})
      }
       }
       )
   },
